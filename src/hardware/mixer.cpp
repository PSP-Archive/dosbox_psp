...
extern "C" int sceAudio_driver_38553111(unsigned short, unsigned short, char);
extern "C" int sceAudio_driver_E0727056(int, void *);
...
static int MIXER_FillBufferThread(SceSize args, void *argp) {
    ...
    sceAudio_driver_38553111(mixer.blocksize, mixer.freq, 2);
	...
	while(1) {
		...
		SDL_UnlockAudio();
		sceAudio_driver_E0727056(PSP_AUDIO_VOLUME_MAX, curr_ptr);
